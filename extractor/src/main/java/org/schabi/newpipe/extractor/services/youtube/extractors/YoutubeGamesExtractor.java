...
public class YoutubeGamesExtractor extends KioskExtractor<StreamInfoItem> {
    private JsonObject initialData;

    public YoutubeGamesExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader) throws IOException, ExtractionException {
        // @formatter:off
        final byte[] body = JsonWriter.string(prepareDesktopTrendingJsonBuilder(getExtractorLocalization(),
                getExtractorContentCountry(), "/feed/trending?bp=4gIcGhpnYW1pbmdfY29ycHVzX21vc3RfcG9wdWxhcg==")
                .value("browseId", "FEtrending")
                .value("params", "4gIcGhpnYW1pbmdfY29ycHVzX21vc3RfcG9wdWxhcg==")
                .done())
                .getBytes(UTF_8);
        // @formatter:on
