...
public class YoutubeMoviesExtractor extends KioskExtractor<StreamInfoItem> {
    private JsonObject initialData;

    public YoutubeMoviesExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader) throws IOException, ExtractionException {
        ...
        final byte[] body = JsonWriter.string(prepareDesktopTrendingJsonBuilder(getExtractorLocalization(),
                getExtractorContentCountry(), "/feed/trending?bp=4gIKGgh0cmFpbGVycw==")
                .value("browseId", "FEtrending")
                .value("params", "4gIKGgh0cmFpbGVycw==")
                .done())
                .getBytes(UTF_8);
        // @formatter:on
