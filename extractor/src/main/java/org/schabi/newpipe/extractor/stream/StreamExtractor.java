...
public abstract class StreamExtractor extends Extractor {
    ...
    //是否已顶
    public abstract boolean isLike() throws ParsingException;
    /**
    ...
    //是否已踩
    public abstract boolean isDisLike() throws ParsingException;

    //是否已订阅
    public abstract boolean isSubscribed() throws ParsingException;

    public abstract String getVideoId() throws ParsingException;

    public abstract String getChannelId() throws ParsingException;

    public abstract String getVideostatsPlaybackUrl() throws ParsingException;
