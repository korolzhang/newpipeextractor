...
public class YoutubeStreamInfoItemExtractor implements StreamInfoItemExtractor {
    ...
    @Override
    public String getFeedbackToken() throws ParsingException {
        try {
            JsonArray topLevelButtons = videoInfo.getObject("menu").getObject("menuRenderer").getArray("topLevelButtons");
            for (final Object topLevelButton:topLevelButtons) {
                String iconType = ((JsonObject)topLevelButton).getObject("buttonRenderer").getObject("icon").getString("iconType");
                if (iconType.equals("DISMISSAL")) {
                    String feedbackToken = ((JsonObject)topLevelButton).getObject("buttonRenderer").getObject("serviceEndpoint").getObject("feedbackEndpoint").getString("feedbackToken");
                    return feedbackToken;
                }
            }
        } catch (Exception e) {
            throw new ParsingException("Could not get feedback token", e);
        }
