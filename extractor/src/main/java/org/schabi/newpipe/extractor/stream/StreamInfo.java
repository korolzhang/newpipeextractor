...
public class StreamInfo extends Info {
    ...
    private static StreamInfo extractOptionalData(StreamInfo streamInfo, StreamExtractor extractor) {
        ...
        try {
            streamInfo.setLike(extractor.isLike());
        } catch (Exception e) {
            streamInfo.addError(e);
        }
        try {
        ...
        try {
            streamInfo.setDisLike(extractor.isDisLike());
        } catch (Exception e) {
            streamInfo.addError(e);
        }
        try {
            streamInfo.setSubscribed(extractor.isSubscribed());
        } catch (Exception e) {
            streamInfo.addError(e);
        }
        try {
        ...
        try {
            streamInfo.setVideoId(extractor.getVideoId());
        } catch (Exception e) {
            streamInfo.addError(e);
        }

        try {
            streamInfo.setChannelId(extractor.getChannelId());
        } catch (Exception e) {
            streamInfo.addError(e);
        }

        try {
            streamInfo.setVideostatsPlaybackUrl(extractor.getVideostatsPlaybackUrl());
        } catch (Exception e) {
            streamInfo.addError(e);
        }
    ...
    public void setVideostatsPlaybackUrl(String videostatsPlaybackUrl) {
