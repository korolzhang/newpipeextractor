...
public class YoutubeChannelInfoItemExtractor implements ChannelInfoItemExtractor {
    ...
    public boolean isSubscribed() throws ParsingException {
        try {
            if (!channelInfoItem.has("subscriptionButton")) {
                // Subscription count is not available for this channel item.
                return false;
            }

            return channelInfoItem.getObject("subscriptionButton").getBoolean("subscribed");
        } catch (Exception e) {
    ...
    public String getChannelId() throws ParsingException {
        try {
            if (!channelInfoItem.has("channelId")) {
                // Channel have no description.
                return null;
            }

            return channelInfoItem.getString("channelId");
        } catch (Exception e) {
