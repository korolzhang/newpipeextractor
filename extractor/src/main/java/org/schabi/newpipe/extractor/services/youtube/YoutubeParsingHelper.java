...
public class YoutubeParsingHelper {
    ...
    @Nonnull
    public static JsonBuilder<JsonObject> prepareDesktopNextPageJsonBuilder(
            @Nonnull final Localization localization,
            @Nonnull final ContentCountry contentCountry,
            @Nonnull final String clickTrackingParams,
        ...
        return JsonObject.builder()
                ...
                .value("clickTrackingParams", clickTrackingParams)
                .end()
                .end();
        // @formatter:on
    }
    ...
    @Nonnull
    public static JsonBuilder<JsonObject> prepareDesktopTrendingJsonBuilder(
            @Nonnull final Localization localization,
            @Nonnull final ContentCountry contentCountry,
        ...
        return JsonObject.builder()
                ...
                .value("clientName", "WEB")
                .value("clientVersion", getClientVersion())
                .object("mainAppWebInfo")
                .value("graftUrl", url)
                .value("webDisplayMode", "WEB_DISPLAY_MODE_BROWSER")
                .value("isWebNativeShareAvailable", false)
                .end()
                .end()
                .object("user")
                // TO DO: provide a way to enable restricted mode with:
