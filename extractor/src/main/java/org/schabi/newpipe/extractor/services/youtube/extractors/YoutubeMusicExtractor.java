...
public class YoutubeMusicExtractor extends KioskExtractor<StreamInfoItem> {
    private JsonObject initialData;

    public YoutubeMusicExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader) throws IOException, ExtractionException {
        ...
        final byte[] body = JsonWriter.string(prepareDesktopTrendingJsonBuilder(getExtractorLocalization(),
                getExtractorContentCountry(), "/feed/trending?bp=4gINGgt5dG1hX2NoYXJ0cw==")
                .value("browseId", "FEtrending")
                .value("params", "4gINGgt5dG1hX2NoYXJ0cw==")
                .done())
                .getBytes(UTF_8);
        // @formatter:on
